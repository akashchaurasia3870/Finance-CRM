...
export default function NewPortfolio({ clients = [] }) {
        ...
        <Layout>
            <div className="space-y-6">
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-theme-primary">Create Portfolio</h1>
                        <p className="text-theme-secondary">Add new portfolio to account</p>
                    </div>
                </div>
