...
export default function MeetingsEdit({ meeting, users = [] }) {
    ...
    const handleSubmit = (e) => {
        ...
        router.put(`/meetings/${meeting.id}`, formData, {
            onSuccess: () => {
        ...
        <Layout>
            <div className="space-y-6">
                <div className="flex justify-between items-center">
                    <div>
                        <h1 className="text-2xl font-bold text-theme-primary">Edit Meeting</h1>
                        <p className="text-theme-secondary">Update meeting details</p>
                    </div>
