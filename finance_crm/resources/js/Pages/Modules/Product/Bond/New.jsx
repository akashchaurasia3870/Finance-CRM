        ...
        <Layout>
            <div className="space-y-6">
                <div className="flex justify-between items-center">
                    <div>
                        <h1 className="text-2xl font-bold text-theme-primary">Create Bond</h1>
                        <p className="text-theme-secondary">Add a new bond product</p>
                    </div>
                    <Link href="/bond">
                        <ThemedButton variant="secondary">Back to Bonds</ThemedButton>
                    </Link>
                </div>
